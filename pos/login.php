...
<head>
    ...
    <title>Ontomeel POS | Secure Login</title>
...
<body>
    ...
    <div class="login-card">
        <div class="logo-section">
            ...
            <h1>Staff Portal</h1>
            <p>Welcome to Ontomeel Library POS</p>
        </div>
        ...
        <form id="loginForm">
            ...
            <button type="submit" id="submitBtn" class="btn-login">
                SECURE LOGIN <i class="fa-solid fa-arrow-right" style="margin-left:8px; font-size:0.8rem; vertical-align:middle;"></i>
            </button>
        </form>
    ...
    <script>
        ...
        loginForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                submitBtn.innerHTML = 'SECURE LOGIN <i class="fa-solid fa-arrow-right" style="margin-left:8px; font-size:0.8rem; vertical-align:middle;"></i>';
            }
        });
