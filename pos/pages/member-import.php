    ...
    <div class="main-wrapper">
        <header>
            ...
            <div class="header-tools">
                <a href="member.php" class="btn-secondary" style="border: 1px solid var(--border-light); padding: 0.8rem 1.2rem; border-radius: 10px; font-weight: 600; text-decoration: none; color: inherit;">
                    Back to Members
                </a>
            </div>
        </header>
